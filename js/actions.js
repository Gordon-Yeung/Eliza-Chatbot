...
function displayChat(){
	...
	html += "<h2 style = 'text-align: center'>ELIZA</h2><br>"
...
function getElizaMessageHTML(message){
	return '<div class="chat-message-outter-wrapper"><img src="./assets/imgs/gojo_satoru.jpg" class="chat-message-icon"><div class="chat-message-wrapper eliza-message"><p class="chat-message-text text-left">' + message + '</p><p class="chat-user-text">ELIZA</p></div></div>';
}
/*
 * Returns proper HTML for formatting a message from user into #chat-area
 */
function getUserMessageHTML(message){
	return '<div class="chat-message-outter-wrapper text-right"><div class="chat-message-wrapper you-message"><p class="chat-message-text text-left">' + message + '</p><p class="chat-user-text">You</p></div><img src="./assets/imgs/megumi.jpg" class="chat-message-icon"></div>';
}
/*
